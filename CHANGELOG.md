...
- **Ukrainian localisation (`uk`)** — `docs/README.uk.md` and `docs/CONTRIBUTING.uk.md`, plus **Українська** in the onboarding language selector
- `LICENSE` — PolyForm Noncommercial License 1.0.0 (© 2026 Vorssaint, Ping4Win)
